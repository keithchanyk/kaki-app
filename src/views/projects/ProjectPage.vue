...
export default {
    ...
    data(){
        ...
        methods:{
            get_details(){
                axios.get('http://localhost/is216/kakidb-2/kakidb-2/project/read.php')
                    .then(response => {
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-12 ">
                    ...
                    <h3 class="row fw-bold text-dark">Recommended For You</h3>
                        <br>
                        ...
                        <div v-for="project in project_details" :key="project.id" class="mt-4 col d-flex justify-content-start">
                            <div class="card glass">
                                ...
                                <div class="card-body mb-1">
                                    ...
                                    <h6 class="mt-5 fw-normal opacity-50">by {{project.org_name}}</h6>
                                    <br>
                                    ...
                                    <h6 class="fw-normal"><span></span>{{project.proj_date}}</h6>
                                    <br>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <h6 class="fw-normal"><span></span>{{project.starttime}} - {{project.endtime}}</h6>
                                    <br>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <h6 class="fw-normal"><span></span>{{project.for_who}}</h6>
                                    <br>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <br>
                                    <h6 style="font-size: 12px;" class="fw-light">{{project.capacity}}</h6>
                                </div>
